        ...
        <div ref={contentRef} className="grid lg:grid-cols-2 gap-12 mb-16 items-start">
          ...
          <div>
            ...
            <p className="text-slate-600 leading-relaxed text-lg mb-6">
              Depending on the size and condition of the apartment, house, or business, Maid-Service charges 
              an hourly rate for home cleaning services. Our house cleaning professionals work hard and 
              attentively to give excellent service and to make you feel at ease and satisfied with our work.
            </p>
            
            <div className="bg-primary/5 rounded-xl p-6">
              <p className="text-slate-700 leading-relaxed">
                Cleaning services for the home and workplace. We handle everything from modest to huge projects.
              </p>
            </div>
          </div>
          ...
          <div className="relative h-[400px] md:h-[450px] w-full rounded-2xl overflow-hidden shadow-lg">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full mb-3">
                ...
                <span className="text-primary font-semibold text-sm">Hourly Rates</span>
              </div>
              <h3 className="text-2xl font-bold text-white">Professional Cleaning</h3>
              <p className="text-white/80">Quality service at competitive rates</p>
            </div>
          </div>
        </div>
