// components/services/spring-cleaning-content.tsx
"use client";
...
export function SpringCleaningContent() {
        ...
        <div ref={contentRef} className="bg-white mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-slate-800">
              Why Choose Spring Cleaning?
            </h2>
          </div>
          
          <p className="text-slate-600 leading-relaxed text-lg mb-6">
            Cleaning throughout the year helps keep on top of things and a professional deep clean once or 
            twice a year helps maintain a clean home all year round. Medicare Link Cleaning Services have 
            many years of cleaning experience and provide deep cleaning at a time that suits you.
          </p>
          
          <div className="bg-primary/5 rounded-xl p-6 mb-6">
            <p className="text-slate-700 leading-relaxed">
              A comfortable home helps reduce stress, especially if the professionals do the work for you!
            </p>
          </div>
          
          <p className="text-slate-600 leading-relaxed mb-6">
            Just let us know what your requirements are and we can arrange a plan to meet your needs. 
            Book a cleaning job today and avoid any permanent stains or unsightly dirt fixing into your 
            home before it's too late.
          </p>
          
          <div className="bg-slate-50 rounded-xl p-6">
            <p className="text-slate-700 leading-relaxed">
              A bit like a chipped windscreen, organizing a deep, thorough clean will remove stains and 
              bacteria before they start.
            </p>
          </div>
        </div>
