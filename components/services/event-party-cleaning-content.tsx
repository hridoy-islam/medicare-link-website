...
export function EventPartyCleaningContent() {
  ...
  const Services = [
    ...
    "Home Maid Service", "Move-In/Move Out Cleaning",
    "Office Cleaning",
        ...
        <div ref={contentRef} className="grid lg:grid-cols-2 gap-12 mb-16 items-start">
          ...
          <div>
            ...
            <p className="text-slate-600 leading-relaxed text-lg mb-6">
              Our after-party cleaners are perfectly qualified to provide first-class cleaning every time. 
              After a long hard night of partying, the last thing you want to do the next morning is clean, 
              and that is what we can help with. Our before or after Party Cleaning is brilliant – made to 
              suit your needs and hopefully remove at least one of your headaches! We can provide you with 
              quality and reliable cleaners before or after Party Cleaning Service in London at the best quote.
            </p>
            
            <div className="bg-primary/5 rounded-xl p-6 mb-6">
              <p className="text-slate-700 leading-relaxed">
                Most people only have time to clean on the weekends, but what happens when you organize a party 
                on weekend? When you use our residential and commercial cleaning business, you're freeing up 
                your weekends for fun rather than for chores.
              </p>
            </div>
            
            <p className="text-slate-600 leading-relaxed">
              The flexibility of the services offered by our house cleaning company means you have complete 
              control over your house and apartment cleaning. We work with you to make sure you receive your 
              preferred before or after-party cleaning schedule. When you hire our cleaning services, you receive 
              a customized house cleaning checklist that our maid and house cleaning staff follow closely, so 
              your expectations for a clean home are met every time.
            </p>
          </div>
          ...
          <div className="relative h-[400px] md:h-[450px] w-full rounded-2xl overflow-hidden shadow-lg">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full mb-3">
                ...
                <span className="text-primary font-semibold text-sm">Party Cleaning</span>
              </div>
              <h3 className="text-2xl font-bold text-white">Enjoy Your Party</h3>
  ...
  <div className="space-y-3">
    {Services.slice(0, Math.ceil(Services.length / 2)).map((service, idx) => (
      <div
        key={idx}
        className="flex items-center gap-2 bg-slate-50 rounded-lg px-4 py-2 cursor-pointer hover:bg-primary/10 transition-colors duration-300 group"
        onClick={() => {
