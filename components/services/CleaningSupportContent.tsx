    ...
    <main ref={sectionRef} className="bg-white">
      ...
      <div ref={headerRef} className="bg-slate-50 py-16">
        <div className="container mx-auto  text-center">
          ...
          <p className="text-lg text-slate-600 leading-relaxed pb-8">
            We offer a full range of professional cleaning options, using top
            quality cleaning materials and products, to achieve brilliant
            results for your home or office.
          </p>
            ...
            {cleaningServices.map((service, index) => (
              ...
              >
                ...
                <div className="p-5 text-center">
                  <h3 className="font-bold text-slate-800 mb-2 text-XL tracking-wide leading-tight">
                    {service.title}
                  </h3>
